        ...
        <div className="bg-gray-100 p-6 min-h-screen">
            <div className="max-w-7xl mx-auto">
                <div className="mb-3 flex justify-between">
                    ...
                    <div
                        className="inline-flex relative space-x-1 border-2 border-indigo-600 hover:bg-gray-100 cursor-pointer px-4 py-1 rounded-lg"
                        onClick={openProfile}>
                        ...
                        {isOpen && (
                            <>
                                <div className='w-full bg-white border absolute -left-1 top-10 rounded-lg p-1'>
