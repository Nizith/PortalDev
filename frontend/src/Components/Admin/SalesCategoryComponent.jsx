        ...
        <table className="min-w-full border border-collapse table-auto bg-gradient-to-r from-white via-gray-100 to-white rounded-xl overflow-hidden shadow-lg">
          <thead>
            <tr className="bg-gradient-to-r from-slate-900 to-indigo-600 text-white text-sm tracking-wide">
              ...
              <th className="py-4 px-4 font-bold uppercase border">Sales Category</th>
              <th className="py-4 px-4 font-bold uppercase border">Account Manager</th>
              <th className="py-4 px-4 font-bold uppercase border">Manager</th>
              <th className="py-4 px-4 font-bold uppercase border">Sales Engineer</th>
          ...
          <tbody>
            {filteredCoordinators.map((coordinator) => (
              <tr key={coordinator._id} className="hover:bg-gray-200 transition-all duration-300 ease-in-out">
                ...
                <td className="py-4 px-4 font-semibold border">{coordinator.SalesCategory}</td>
                <td className="py-4 px-4 font-semibold border">{coordinator.AccountManager}</td>
                <td className="py-4 px-4 font-semibold border">{coordinator.Manager}</td>
                <td className="py-4 px-4 font-semibold border">{coordinator.SalesEngineer}</td>
