...
// Main Component
export default function PrevContractAdd() {
        ...
        <div className='flex items-center justify-center min-h-screen'>
            <div className='bg-zinc-200 bg border border-neutral-500 rounded-2xl p-8 w-full max-w-4xl'>
                <form className='m-0' onSubmit={handleSubmit}>
                    ...
                    <button type="button" onClick={nextStep} className='bg-green-800 hover:ring-2 ring-green-500 text-green-200 duration-300 flex ml-auto mt-6 px-8 py-2 rounded-lg font-semibold'>
                        Next
                    </button>
                </form>
            </div>
                ...
                <div className='bg-zinc-200 border border-neutral-500 rounded-2xl p-8 w-full max-w-4xl'>
                    <form className='m-5' onSubmit={handleSubmit}>
                        ...
                        <div className='flex justify-between mt-6'>
                            <button type="button" onClick={prevStep} className='bg-blue-800 hover:ring-2 ring-blue-500 text-blue-200 duration-300 flex px-8 py-2 rounded-lg font-semibold'>
                                Previous
                            </button>
                            <button type="button" onClick={nextStep} className='bg-green-800 hover:ring-2 ring-green-500 text-green-200 duration-300 px-8 py-2 rounded-lg font-semibold'>
                                Next
                            </button>
                        </div>
                    </form>
                ...
                <div className='my-10 mx-4 border border-neutral-500 bg-zinc-200 rounded'>
                    ...
                    <form className='m-10 mt-5 mb-5' onSubmit={handleSubmit}>
                        ...
                        <div className='flex justify-between mt-6'>
                            ...
                            <button type="submit" className='bg-green-800 hover:ring-2 ring-green-500 text-green-200 px-8 py-2 rounded-lg font-semibold'>
                                Submit
                            </button>
                        </div>
                    </form>
